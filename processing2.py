...
def find_relevance_documents(queryVector, diction2):
    result = {}
    for key_dic in diction2:
        value_dic = diction2[key_dic]
...
def build_vec_mod():
    ...
    avg = 0
    for q in range(1,2):
        query = get_query2.get_current_query(q)
